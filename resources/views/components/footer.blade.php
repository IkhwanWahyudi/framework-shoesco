<footer class="h-auto bg-[#4d2f20] flex justify-center text-slate-600">
    <div class="container py-8 flex justify-around">
        <div class="self-center">
            <img src="{{ asset('assets/images/logo-white.png') }}" alt="Logo Shoes.co" class="h-40">
        </div>
        ...
        <div class="flex flex-col gap-1">
            ...
            <div class="bg-white h-36 mr-16 rounded-lg mb-2"></div>
            <a href="mailto:ikhwanw06@gmail.com"
                class="group flex gap-2 p-2 mr-16 rounded-lg hover:bg-white transition ease-in">
                <svg class="fill-white group-hover:fill-[#4d2f20] transition ease-in"
                ...
                <p class="text-white group-hover:text-[#4d2f20] transition ease-in">ikhwanw06@gmail.com</p>
            </a>
            <a href=""
                class="group flex gap-2 p-2 mr-16 rounded-lg hover:bg-white hover:text-[#4d2f20] transition ease-in">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" class="fill-white group-hover:fill-[#4d2f20] transition ease-in">
                ...
                <p class="text-white group-hover:text-[#4d2f20] transition ease-in">+62 896 9382 7183</p>
            </a>
        </div>
...
<p class="p-4 bg-[#000000ea] text-center text-white">© 2023 Ikhwan | Universitas Mulawarman</p>
